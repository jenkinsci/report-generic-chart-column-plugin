...
/**
 * Test class for FINAL_DOWN_BIG_OK preset equation.
 * 
 * Combination: LONG_DOWN_BIG_OK or SHORT_DOWN_BIG_OK or IMMEDIATE_DOWN_OK
 */
class FinalDownBigOkTest {

    private static final String EQUATION_ID = "FINAL_DOWN_BIG_OK";
    ...
    void testGeometricMeanSensitivity() throws IOException, URISyntaxException {
        List<String> data = createDataList(100, 200, 90, 85, 80);
        assertTrue(evaluateEquation(EQUATION_ID, "20 5 20", data));
    }
    ...
    void testWithLogging() throws IOException, URISyntaxException {
        ...
        EvaluationResult result = evaluateWithLog(EQUATION_ID, "5 5 5", data);
